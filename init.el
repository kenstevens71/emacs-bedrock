...
(custom-set-variables
 ...
 '(package-selected-packages
   '(company-glsl glsl-mode yasnippet company lsp-mode vscode-icon all-the-icons dired-sidebar pyimport importmagic flycheck markdown-mode move-text multiple-cursors which-key)))
(custom-set-faces
